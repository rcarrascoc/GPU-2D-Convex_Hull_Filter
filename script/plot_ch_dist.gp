...
out     = 'plots/ch_prob_'.name.'_dist.eps'
...
set key Left top right reverse samplen 3.0 font "Courier,22" spacing 1 
#set key Left bot right reverse samplen 3.0 font "Courier,18" spacing 1 


data = 'data/ch_prob_'.name.'.dat'

plot    data              using 1:($2)       title "[CPU] CGAL:convex-hull-2"           with lp ls 6, \
        data              using 1:($6)       title "[CPU] CGAL:ch-graham-andrew"        with lp ls 7, \
        data              using 1:($18)      title "[GPU] proposed-filter"                     with lp ls 2, \
        data              using 1:($22)      title "[GPU] cub-flagged"                  with lp ls 3, \
        data              using 1:($26)      title "[GPU] thrust-scan"                  with lp ls 4, \
        data              using 1:($30)      title "[GPU] thrust-copy"                  with lp ls 5